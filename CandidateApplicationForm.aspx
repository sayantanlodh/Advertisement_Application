<%@ Page Language="C#" AutoEventWireup="true" Codefile="CandidateApplicationForm.aspx.cs" Inherits="Advertisement_Application.CandidateApplicationForm" %>
        ...
        <div>
             <table>
                    ...
                    <tr>
                        ...
                        <td>
                             <asp:DropDownList ID="DdlState" runat="server" AppendDataBoundItems="true" DataTextField="state_name"
                        ...
                        <td>
                           <asp:DropDownList ID="DdlDistrict" runat="server" AppendDataBoundItems="true" DataTextField="district_name"
             ...
             <label class="col-sm-10 col-form-label" style="color: black">Select District*  </label>
<asp:DropDownList ID="Drop01" runat="server" CssClass="form-control select2" data-show-subtext="true" data-live-search="true"  DataTextField="Data" DataValueField="code" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" >
